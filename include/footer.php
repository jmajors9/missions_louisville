			...
			<div class="container footer-container">
				<div class="row">
					...
					<div class="col-sm-4 center-footer hidden-xs hidden-xxs">
						<div class="footer-fleur-top center-block"> 
		...
		<footer class="footer footer-bottom panel-footer">      
	      	...
	      	<div class="text-center">
	      		<p>Copyright &copy; 2015 - TheVille || A <a label="email" href="mailto:help@missionsLouisville.org?subject=missionsLouisville.org">MajorStudios</a> Website</p>
	      	</div>      			
		</footer>
