// highlight the active countries

	// iterate through the region for country name (id or title)
		$("path").
		// get element ids
	// compare theto the events in data.json
	// print the events
	// change fill color on countries
	getElementById('');
